...
public class WidgetRegistryOptionEntry<T extends ConfigRegistryOption<?>> extends WidgetListEntryBase<T> {
    ...
    private static class ButtonListener<T extends ConfigRegistryOption<?>> implements IButtonActionListener {
        ...
        public ButtonListener(ButtonListener.Type type, WidgetRegistryOptionEntry<T> parent) {
            this.parent = parent;
            this.type = type;
        }
